          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <div className="hidden md:block md:pl-20">
                ...
                <TypographyP className=" text-neutral-500 dark:text-neutral-500 ">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Consequuntur culpa, dolores sapiente magnam eveniet officiis,
                  maxime adipisci beatae voluptates odit sint eligendi! Veniam
                  similique, quidem consectetur error cum placeat assumenda.
                </TypographyP>
              </div>
            </div>
